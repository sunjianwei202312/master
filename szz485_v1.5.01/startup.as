	...
	; Compiler options:
	;
	; -oSZZ485_V1.4.cof -mSZZ485_V1.4.map --summary=default \
	; --output=default timer1.p1 usart.p1 DS3231.p1 led.p1 main.p1 sys.p1 \
	; CRC.p1 rtc.p1 eeprom.p1 timer2.p1 infrare.p1 sys_com.p1 --chip=16F883 \
	; -I..\SZZ485_V1.4\include -P --runtime=default \
